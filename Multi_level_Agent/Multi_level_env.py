...
class multi_level_env:
    def __init__(self,Agent_ID):#Agent_ID should Match the one in the Simulator 
    ...
    def step(self,action):
        ...
        if self.ID==1: #Handling action dim miss match
            z=np.zeros(11,)
            z[[7,9]]=action
        next_state, reward, done, info = self.env.step(z)
