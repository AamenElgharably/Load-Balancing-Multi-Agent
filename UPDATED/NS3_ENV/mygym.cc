...
namespace ns3 {
  ...
  MyGymEnv::GetReward() {
    ...
    if (m_chooseReward == 0) {
      if(Agent_ID==1)
      {
        reward=m_dlThroughputVec.at(0)+m_dlThroughputVec.at(2)+m_dlThroughputVec.at(5);//FIRST CLUSTER
      }
      else if(Agent_ID==2)
      {
        reward=m_dlThroughputVec.at(3)+m_dlThroughputVec.at(1)+m_dlThroughputVec.at(4);//Second CLUSTER
      }
      else
      {
        reward = rewards.at(0);
  ...
  MyGymEnv::ExecuteActions(Ptr < OpenGymDataContainer > action) {
    ...
    if(Agent_ID==3)
    {
      ...
      Current_list.at(1)=actionVectord.at(1);
      Current_list.at(2)=actionVectord.at(2);
      Current_list.at(5)=actionVectord.at(3);
      Current_list.at(8)=actionVectord.at(4);
      Current_list.at(10)=actionVectord.at(5);
    }
