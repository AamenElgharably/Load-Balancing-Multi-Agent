...
class TD3_Agent():
  def __init__(self,alpha,beta,input_dims,tau,gamma,update_actor_interval,warmup,n_actions,max_size,layer1_size,layer2_size,batch_size,noise,ID,chk_dir):
    self.gamma=gamma
    self.tau=tau
    self.max_action=1
    self.min_action=-1
    ...
    self.ID=ID
    self.DIR=chk_dir
    self.actor=ActorNetwork(alpha,input_dims,layer1_size,layer2_size,n_actions,name='Actor'+self.ID,chkpt_dir=self.DIR)
    self.critic_1=CriticNetwork(beta,input_dims,layer1_size,layer2_size,n_actions,name='Critic_1'+self.ID,chkpt_dir=self.DIR)
    self.critic_2=CriticNetwork(beta,input_dims,layer1_size,layer2_size,n_actions,name='Critic_2'+self.ID,chkpt_dir=self.DIR)
    self.target_actor=ActorNetwork(alpha,input_dims,layer1_size,layer2_size,n_actions,name='TargetActor'+self.ID,chkpt_dir=self.DIR)
    self.target_critic_1=CriticNetwork(alpha,input_dims,layer1_size,layer2_size,n_actions,name='Target_Critic_1'+self.ID,chkpt_dir=self.DIR)
    self.target_critic_2=CriticNetwork(alpha,input_dims,layer1_size,layer2_size,n_actions,name='Target_Critic_2'+self.ID,chkpt_dir=self.DIR)
    self.noise=noise
